...
//         const stored = localStorage.getItem('searchHighlightedPost');
//         console.log("📖 Read back from localStorage:", stored ? JSON.parse(stored) : 'Nothing stored');
        
//         // Navigate to feed
//         navigate('/feed');

//         // After storing to localStorage and navigating to feed
// // Call the global function to trigger highlight in Feed
...
//         setTimeout(() => {
//             alert(`✨ Post from search is now highlighted at the top of your feed!`);
//         }, 100);
//     };
